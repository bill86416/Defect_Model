...
# Add Noise (Additive Noise to Training Input Images)
def add_noise(inputs):
     noise = torch.randn_like(inputs) * noise_ratio
     return inputs + noise
...
def main():
   ...
   # Set Parser
    ...
    parser.add_argument('--noise', default=0.1, type=float, help='noise')
    ...
    # Save Model
    PATH = './noise_models/noise_' + str(noise_ratio) + '_cifar_net_epoch_' + str(args.epoch) + '.pth'
