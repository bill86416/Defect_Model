...
# This code adds "Multiplicative" Normal Distribution Noise to All Activation Outputs
...
def main():
   # Set Parser
    ...
    # net_path = './normal_models/normal_cifar_200_net_epoch_200' + '.pth'
    ...
    net.eval()
     ...
     # Defect Model (Add Multiplicative Normal Distribution Noise), Alpha denots different std, and with mean set to 1.0
    ...
    # Add Forward Hook to All Activation Outputs
    hook_handles = {}
