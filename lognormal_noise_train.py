...
def add_noise(inputs):
    ...
    noise_inputs = (inputs * noise).clone()
    return noise_inputs
...
def main():
   ...
   # Set Parser
    ...
    # Add Noise to all samples, No Threshold Setting
    ...
    PATH = './lognormal_models/curv_noise_' + str(noise_ratio) + '_cifar_net_' + 'total_epoch_' + str(args.epoch) + '.pth'
